      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-3xl mb-8">
            <h1 className="text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight ">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://www.linkedin.com/company/learni-formation/"
                target="_blank"
                rel="noopener"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-4xl text-center text-gray-700 ">
            Nos partenaires <span className="text-blue-900">10+</span>{" "}
            dans l'europe
          </div>

          <div className="flex flex-wrap rounded-2xl justify-center gap-5 mt-10 md:justify-around">
            {[1,2,3,4,5,6,7].map((v,k) => (<div className="pt-2 text-gray-400 ">
              <Image
